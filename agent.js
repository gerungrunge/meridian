...
const MANAGER_TOOLS  = new Set(["close_position", "claim_fees", "swap_token", "sweep_dust", "get_position_pnl", "get_my_positions", "get_wallet_balance"]);
...
const DEFAULT_MODEL = process.env.LLM_MODEL || "nousresearch/hermes-3-llama-3.1-405b";
