...
export const config = {
  ...
  gmgn: {
    ...
    maxBuyTaxPct: gmgnValue("maxBuyTaxPct", "gmgnMaxBuyTaxPct", 10),
    maxSellTaxPct: gmgnValue("maxSellTaxPct", "gmgnMaxSellTaxPct", 10),
    requireRenouncedOwner: gmgnValue("requireRenouncedOwner", "gmgnRequireRenouncedOwner", false),
    requireRenouncedMint: gmgnValue("requireRenouncedMint", "gmgnRequireRenouncedMint", false),
    requireRenouncedFreezeAccount: gmgnValue("requireRenouncedFreezeAccount", "gmgnRequireRenouncedFreezeAccount", false),
