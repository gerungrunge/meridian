...
- bins_below = round(${config.strategy.minBinsBelow} + (candidate volatility/5)*${config.strategy.maxBinsBelow - config.strategy.minBinsBelow}) clamped to [${config.strategy.minBinsBelow},${config.strategy.maxBinsBelow}]. If candidate volatility > ${config.strategy.highVolatilityThreshold ?? 3.5}, multiply by ${config.strategy.highVolatilityBinsBoost ?? 1.25} and re-clamp. bins_above = 0.
